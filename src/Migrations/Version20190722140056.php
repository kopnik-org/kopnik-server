 ...
 */
final class Version20190722140056 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT UNSIGNED AUTO_INCREMENT NOT NULL, foreman_id INT UNSIGNED DEFAULT NULL, witness_id INT UNSIGNED DEFAULT NULL, last_login_at DATETIME DEFAULT NULL, confirmed_at DATETIME DEFAULT NULL, first_name VARCHAR(32) NOT NULL, last_name VARCHAR(32) DEFAULT NULL, patronymic VARCHAR(32) DEFAULT NULL, passport_code INT DEFAULT NULL, is_confirmed TINYINT(1) NOT NULL, birth_year INT DEFAULT NULL, latitude NUMERIC(10, 8) DEFAULT NULL, longitude NUMERIC(11, 8) DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_1483A5E9D99379F0 (foreman_id), INDEX IDX_1483A5E9F28D7E1C (witness_id), INDEX IDX_1483A5E98B8E8428 (created_at), INDEX IDX_1483A5E9CFBEB2B3 (is_confirmed), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users_oauths (id INT UNSIGNED AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED DEFAULT NULL, email VARCHAR(100) DEFAULT NULL, access_token VARCHAR(100) NOT NULL, refresh_token VARCHAR(100) DEFAULT NULL, identifier BIGINT NOT NULL, provider VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_88E49D4AA76ED395 (user_id), INDEX IDX_88E49D4A8B8E8428 (created_at), INDEX IDX_88E49D4AE7927C74 (email), UNIQUE INDEX UNIQ_88E49D4A772E836A92C4739C (identifier, provider), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
